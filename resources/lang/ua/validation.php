...
return [
    ...
    */
    ...
    'attributes' => [
        'title_ru'              => 'Заголовок новини (ru)',
        'title_ua'              => 'Заголовок новини (ua)',
        's_desc_ru'             => 'Короткий опис новини (ru)',
        's_desc_ua'             => 'Короткий опис новини (ua)',
        'content_ru'            => 'Зміст новини (ru)',
        'content_ua'            => 'Зміст новини (ua)',
        'alt'                   => 'Назва',
        'link'                  => 'Посилання',
        'name'                  => 'Ім\'я',
        'image_thumb'           => 'Зображення (мале)',
        'image_full'            => 'Зображення (велике)',
        'name_ru'               => 'Назва (ru)',
        'name_ua'               => 'Назва (ua)',
        'desc_ru'               => 'Опис (ru)',
        'desc_ua'               => 'Опис (ua)',
        'item_code'             => 'Артикул товару',
        'gallery'               => 'Зображення товару',
        'username'              => 'Нікнейм',
        'email'                 => 'E-Mail адреса',
        'first_name'            => 'Ім\'я',
        'last_name'             => 'Прізвище',
