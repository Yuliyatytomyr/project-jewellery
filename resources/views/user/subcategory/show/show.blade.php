...
@section('content')
    ...
    <div class="row mt-2">
        ...
        <div class="col-12 breadcrumbs">
            ...
            <span>&nbsp;>&nbsp;</span>
            <a href="{{ asset(app()->getLocale().'/categories/'.$subcategory->category->alias) }}">{{ $subcategory->category->getNameTran() }}</a>
            <span>&nbsp;>&nbsp;</span>
            <a>{{ $subcategory->getNameTran() }}</a>
        </div>
        ...
        <div class="col-3 backet-form filter-item d-n dlg-b">
            @include('user.subcategory.show.layouts.sidebar_filter')
        </div>
        <div class="col-12 col-lg-9">
                    ...
                    <div class="col-12">
                        @foreach($remove_pvalues as $remove_pvalue)
                            ...
                            <div class="filter-tags__item m-2">
                                ...
                                <a href="{{ asset(app()->getLocale().'/subcategories/'.$subcategory->alias.'?gpvalues='.$new_gpvalues_param) }}" class="del-filter d-f jc-e p-0" rel="nofollow">
            ...
            <div class="row">
                <div class="col-12 dlg-n mb-4">
                    <button id="filterMobSubcategory" class="cl-w btn-profile mr-md-3 mr-0">Фильтр</button>
                </div>
            </div>
            <div class="row">
