...
<div class="col-12 card">
    <div class="card-body">
        ...
        <form class="row forms-sample" id="mozaik-edit-form" action="{{ asset(app()->getLocale().'/admin/settings/content/home/mozaiks/'.$mozaik->id) }}" enctype="multipart/form-data" method="post">
            @csrf
            {{ method_field('PUT') }}
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mozaik-alt" name="alt" placeholder="Название мозайки" value="{{ $mozaik->alt }}">
                </div>
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mozaik-name-ru" name="name_ru" value="{{ $mozaik->name_ru }}">
                </div>
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mozaik-name-ua" name="name_ua" value="{{ $mozaik->name_ua }}">
                </div>
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mozaik-link" name="link" placeholder="Скопируйте ссылку для прехода и добавьте сюда" value="{{ $mozaik->link }}">
                </div>

            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Изображение (узкое)*</label>
            ...
            @if($mozaik->show_on)
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Изображение (широкое)*</label>
            ...
            <div class="col-md-6 offset-md-3 mt-4">
                <button type="button" class="btn btn-success w-100" id="mozaik-edit-submit" form="mozaik-edit-form">Редактировать</button>
            </div>
...
<script>
    ...
    $('.card').on('click', '#mozaik-edit-submit', function (e) {
