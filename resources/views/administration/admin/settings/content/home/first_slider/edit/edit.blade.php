...
@section('content')
    <div class="col-12 card">
        <div class="card-body">
            ...
            <form class="row forms-sample" id="f-slider-edit-form" action="{{ asset(app()->getLocale().'/admin/settings/content/home/f-sliders/'.$slider->id) }}" enctype="multipart/form-data" method="post">
                @csrf
                {{ method_field('PUT') }}
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <label for="f-slide-alt">Название*</label>
                        <input type="text" class="form-control" id="f-slide-alt" name="alt" placeholder="Название слайда" value="{{ $slider->alt }}">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <label for="f-slide-link">Ссылка для перехода*</label>
                        <input type="text" class="form-control" id="f-slide-link" name="link" placeholder="Скопируйте ссылку для прехода и добавьте сюда"  value="{{ $slider->link}}">
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-check form-check-flat">
                            <label class="form-check-label">
                                <input type="checkbox" name="show_on" class="form-check-input" @if($slider->show_on == 1) checked @endif> Опубликовать <i class="input-helper"></i>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 offset-md-3 mt-4">
                    <button type="button" class="btn btn-success w-100" id="f-slider-edit-submit" form="f-slider-edit-form">Изменить слайд</button>
                </div>
...
@section('script2')
    <script>
        ...
        $('.card').on('click', '#f-slider-edit-submit', function (e) {
