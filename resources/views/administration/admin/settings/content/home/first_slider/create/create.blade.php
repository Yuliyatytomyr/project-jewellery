...
@section('content')
    <div class="col-12 card">
        <div class="card-body">
            ...
            <form class="row forms-sample" id="f-slider-create-form" action="{{ asset(app()->getLocale().'/admin/settings/content/home/f-sliders') }}" enctype="multipart/form-data" method="post">
                @csrf
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="f-slide-alt" name="alt" placeholder="Название слайда">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="f-slide-link" name="link" placeholder="Скопируйте ссылку для прехода и добавьте сюда">
                    </div>
                ...
                <div class="col-md-6 offset-md-3 mt-4">
                    <button type="button" class="btn btn-success w-100" id="f-slider-create-submit" form="f-slider-create-form">Создать слайд</button>
                </div>
...
@section('script2')
    <script>
        ...
        $('.card').on('click', '#f-slider-create-submit', function (e) {
