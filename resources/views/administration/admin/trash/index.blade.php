                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton4" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">
                                        <h6 class="dropdown-header">Settings</h6>
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                        <a class="dropdown-item" href="#">Something else here</a>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card-body">
                ...
                <p class="card-description">Use <code>class="btn-icons"</code> or <code>class="btn-icons
                        btn-rounded"</code> for fab styled buttons</p>
                <div class="template-demo">
