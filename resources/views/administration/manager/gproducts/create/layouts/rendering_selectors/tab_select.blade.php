<div class="col-md-6 gp-params" id="gp-param-{{ $param->id }}" data-param="{{ $param->id }}">
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-12">
                <select name="param[{{ $param->id }}][]" class="form-control custom-select multiselect-on w-100" id="gp-param-select-{{ $param->id }}" multiple="multiple" form="gproduct-create-form">
                </select>
            </div>
        </div>
    </div>
